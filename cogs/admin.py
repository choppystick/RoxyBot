...
class Admin(commands.Cog):
    ...
    async def ywl(self, ctx):
        await ctx.message.delete()
        adjective = ["dumb", "hot", "cute", "idiot", "amazing", "annoying", "cool"]
        choices = random.choice(adjective)
        await ctx.send("Ywl is lowkey %s af. " % choices)
    ...
    @commands.check(permissions.is_owner)
    async def say(self, ctx, channel: discord.TextChannel = None, *, message: commands.clean_content):
        await ctx.message.delete()
        await channel.send(message)

    @commands.command()
    @commands.check(permissions.is_owner)
    async def reply(self, ctx, channel_id: int, msgid: int, *, message: commands.clean_content):
        await ctx.message.delete()
    ...
    async def change_playing(self, ctx, *, playing: str):
        ...
        try:
            ...
            self.change_config_value("activity", playing)
